...
- Accessibility is that everyone and anyone can use the web, where they have a disability or not, and even work on code for a website. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

- Having responsive design that can make your web application or site work on multiple devices with different screen sizes, have proved naming to your HTML so that if someone is using a screen reader they wont get lost and can understand everything they are inspecting or hovering, and making sure it can be navigated on a keyboard. 

3. How would you explain the concept of a variable to someone new to programming?

- it is a value that can change on different conditions or information that is passed into the program. 

4. What is the purpose of using functions in code?

- for easier code management and it can be reused 
